...
- **Level 2 — designed, not ported:** the `AgentRunner` mapping is concrete; the TS HELIX client
  is the remaining work (small, spec-pinned).
...
## Bring-up order
1. Conformance gate: TS/native crypto reproduces `helix/spec/vectors.json`.
