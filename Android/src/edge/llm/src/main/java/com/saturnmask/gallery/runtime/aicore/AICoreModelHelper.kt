...
package com.saturnmask.gallery.runtime.aicore

import android.content.Context
import android.graphics.Bitmap
import android.util.Log
import com.saturnmask.gallery.common.cleanUpMediapipeTaskErrorMessage
import com.saturnmask.gallery.data.AICoreModelPreference
import com.saturnmask.gallery.data.AICoreModelReleaseStage
import com.saturnmask.gallery.data.ConfigKeys
import com.saturnmask.gallery.data.DEFAULT_MAX_OUTPUT_TOKEN
...
object AICoreModelHelper : LlmModelHelper {
  ...
  private fun logAICoreAccessDetails(context: Context) {
    ...
    val allowedPackages =
      setOf(
        "com.saturnmask.gallery",
        "com.saturnmask.gallery.internal",
        "com.saturnmask.gallery.dev",
      )
