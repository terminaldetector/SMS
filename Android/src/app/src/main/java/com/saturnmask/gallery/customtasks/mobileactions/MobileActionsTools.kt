...
val MOBILE_ACTIONS_CATALOG: List<Pair<String, String>> =
  listOf(
    "turnOnFlashlight" to "Turns the flashlight on",
    "turnOffFlashlight" to "Turns the flashlight off",
    "createContact" to "Creates a contact in the phone's contact list.",
    "sendEmail" to "Sends an email.",
    "showLocationOnMap" to "Shows a location on the map.",
    "openWifiSettings" to "Opens the WiFi settings.",
    "createCalendarEvent" to "Creates a new calendar event.",
  )
