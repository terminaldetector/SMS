...
package com.saturnmask.gallery.customtasks.common
...
data class CustomTaskDataForBuiltinTask(
  ...
  // A saved session to resume instead of starting fresh (e.g. tapping a home-screen Recent Chats
  // entry). Mutually exclusive with initialQuery by construction — Recent Chats never sets query.
