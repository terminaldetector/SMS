 ...
 */
export function shardLlamaArgs(plan: RpcClusterPlan, registered: RpcEndpointDevices[]): ShardLlamaArgs {
    ...
    if (!workers.length) throw new Error('the plan has no workers — this is a local load, not a shard')
